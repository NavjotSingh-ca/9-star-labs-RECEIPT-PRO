...
import { Input, Textarea, Select } from '@design/primitives';
  ...
  return (
    <ErrorBoundary componentName="OrgSettings">
      <>
        ...
        <Card variant="default" className="w-full shadow-sm overflow-hidden bg-surface border border-glass-border">
          <CardHeader className="px-6 py-4 border-b">
            <CardTitle className="text-lg font-bold tracking-tight">Organization Settings</CardTitle>
            <CardDescription className="mt-1 text-sm">
              Configure business info, reimbursement thresholds, approval policies, and integrations.
            </CardDescription>
          </CardHeader>
          <CardContent className="p-6">

            {error && (
              <div className="mb-6 flex items-center gap-2 rounded-xl bg-danger/10 px-4 py-3 text-sm text-danger border border-danger/20" role="alert">
              ...
              >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label htmlFor="org-business-name" className="block text-xs font-bold uppercase tracking-wider text-text-muted mb-1.5">Business Name</label>
                      <Input
                    ...
                    <div>
                      <label htmlFor="org-business-number" className="block text-xs font-bold uppercase tracking-wider text-text-muted mb-1.5">CRA Business Number (GST/BN)</label>
                      <Input
                    ...
                    <div>
                      <label htmlFor="org-address" className="block text-xs font-bold uppercase tracking-wider text-text-muted mb-1.5">Address</label>
                      <Textarea
                        id="org-address"
                    ...
                    <div>
                      <label htmlFor="org-province" className="block text-xs font-bold uppercase tracking-wider text-text-muted mb-1.5">Province</label>
                      <Select
                        id="org-province"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <div className="flex items-center justify-between rounded-xl border bg-surface-raised p-4">
                      <div className="flex items-center gap-3">
                        <div className="h-10 w-10 overflow-hidden rounded-xl bg-surface p-1">
                      ...
                      <Button
                        variant={qboConnected ? "outline" : "primary"}
                        size="sm"
