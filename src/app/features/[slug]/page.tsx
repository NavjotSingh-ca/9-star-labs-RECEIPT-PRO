    ...
    <div className="min-h-screen bg-obsidian text-text-primary selection:bg-champagne/30">
      ...
      <main className="pt-24 pb-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          ...
          {/* Benefits */}
          <div id="benefits" data-reveal className="mb-16 rounded-2xl border border-champagne/15 bg-champagne/[0.02] p-6 sm:p-8">
          ...
          <div className="space-y-24">
            {feature.sections.map((section, idx) => (
              <div key={section.title} id={`section-${idx}`} data-reveal className="relative">
          ...
          {/* Related Features */}
          {related.length > 0 && (
            <div id="related" data-reveal className="mt-20 pt-12 border-t border-glass-border">
