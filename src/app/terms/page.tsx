...
import { ArrowLeft, FileSignature, List } from 'lucide-react';
...
function Section({ id, title, children }: { id: string; title: string; children: React.ReactNode }) {
  return (
    <section id={id} className="scroll-mt-24 animate-in fade-in slide-up-from-bottom-4 duration-700">
      <h2 className="mt-12 mb-5 text-xl font-bold text-text-primary border-b border-glass-border pb-3.5">
        {title}
      </h2>
 ...
 * Server-rendered for SEO and speed with scroll-reveal animations.
 */
    ...
    <div className="min-h-screen bg-obsidian">
      <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 sm:mb-8">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-sm font-semibold text-champagne transition hover:text-champagne-dim group"
          >
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <article className="flex-1 min-w-0">
            <div className="rounded-[2.5rem] border border-glass-border bg-card p-6 sm:p-10 lg:p-14">
              {/* Header */}
              <header className="mb-8 sm:mb-10 flex items-start gap-5 sm:gap-6 border-b border-glass-border pb-6 sm:pb-8">
                <div className="flex h-14 w-14 sm:h-16 sm:w-16 flex-shrink-0 items-center justify-center rounded-xl bg-champagne/15 shadow-[0_0_24px_-4px_rgba(203,182,155,0.2)]">
                  <FileSignature className="h-7 w-7 sm:h-8 sm:w-8 text-champagne" />
                </div>
              ...
              {/* Opening statement */}
              <div className="mb-6 sm:mb-8 rounded-[2rem] border border-champagne/20 bg-champagne/[0.04] p-4 sm:p-5">
                <p className="text-[0.9375rem] leading-7 sm:text-sm sm:leading-7 text-text-secondary">
              ...
              <nav className="mb-10 sm:hidden" aria-label="Table of Contents">
                <div className="rounded-[2rem] border border-glass-border bg-gradient-to-br from-champagne/[0.03] via-surface/50 to-transparent p-5">
                  ...
                  <ol className="space-y-1.5">
                    {TOC.map(({ id, label }) => (
                      <li key={id}>
                        <a
                          href={`#${id}`}
                          className="block text-sm text-text-secondary hover:text-champagne transition-colors py-1"
                        >
                          {label}
                        </a>
                      </li>
          ...
          <aside className="hidden lg:block w-72 flex-shrink-0" aria-label="Table of Contents">
